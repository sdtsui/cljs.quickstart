...
var len__17884__auto___18098 = arguments.length;
var i__17885__auto___18099 = (0);
while(true){
if((i__17885__auto___18099 < len__17884__auto___18098)){
args__17891__auto__.push((arguments[i__17885__auto___18099]));

var G__18100 = (i__17885__auto___18099 + (1));
i__17885__auto___18099 = G__18100;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq18097){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18097));
});
/**
...
var vec__18102 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__18102,(0),null);
var words = cljs.core.nthnext.call(null,vec__18102,(1));
...
var G__18104 = clojure.set.rename_keys.call(null,m,kmap);
var G__18104__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__18104,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__18104);
return G__18104__$1;
} else {
return m;
}
...
var args__17891__auto__ = [];
var len__17884__auto___18107 = arguments.length;
var i__17885__auto___18108 = (0);
while(true){
if((i__17885__auto___18108 < len__17884__auto___18107)){
args__17891__auto__.push((arguments[i__17885__auto___18108]));

var G__18109 = (i__17885__auto___18108 + (1));
i__17885__auto___18108 = G__18109;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__18105_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__18105_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__18105_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__18105_SHARP_)){
return p1__18105_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__18105_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq18106){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18106));
});
/**
...
var vec__18113 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__18113,(0),null);
var names = cljs.core.nth.call(null,vec__18113,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__18113,tag_name,names){
return (function (p1__18110_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__18110_SHARP_));
});})(matches,vec__18113,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__18113,tag_name,names){
return (function (p1__18111_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__18111_SHARP_));
});})(matches,vec__18113,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__18114){
var vec__18117 = p__18114;
var tag = cljs.core.nth.call(null,vec__18117,(0),null);
var content = cljs.core.nthnext.call(null,vec__18117,(1));
...
var vec__18118 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__18118,(0),null);
var id = cljs.core.nth.call(null,vec__18118,(1),null);
var class$ = cljs.core.nth.call(null,vec__18118,(2),null);
